                                                    ...
                                                    : muni.slug === 'niyodogawa'
                                                        ...
                                                        : muni.slug === 'nakatosa'
                                                          ...
                                                          : muni.slug === 'uchiko'
                                                            ...
                                                            : muni.slug === 'onomichi'
                                                              ? ONOMICHI_PLACE_PHOTO
                                                            : muni.slug === 'fukuyama'
                                                              ? FUKUYAMA_PLACE_PHOTO
                                                            : muni.slug === 'fuchu'
                                                              ? FUCHU_PLACE_PHOTO
                                                            : muni.slug === 'miyoshishi'
                                                              ? MIYOSHISHI_PLACE_PHOTO
                                                            : muni.slug === 'shobara'
                                                              ? SHOBARA_PLACE_PHOTO
                                                            : muni.slug === 'otake'
                                                              ? OTAKE_PLACE_PHOTO
                                                            : muni.slug === 'higashihiroshima'
                                                              ? HIGASHIHIROSHIMA_PLACE_PHOTO
                                                            : muni.slug === 'akitakata'
                                                              ? AKITAKATA_PLACE_PHOTO
                                                            : muni.slug === 'hatsukaichi'
                                                              ? HATSUKAICHI_PLACE_PHOTO
                                                            : muni.slug === 'etajima'
                                                              ? ETAJIMA_PLACE_PHOTO
                                                            : muni.slug === 'fuchucho'
                                                              ? FUCHUCHO_PLACE_PHOTO
                                                            : muni.slug === 'kaita'
                                                              ? KAITA_PLACE_PHOTO
                                                            : muni.slug === 'kumano'
                                                              ? KUMANO_PLACE_PHOTO
                                                            ...
                                                            : muni.slug === 'akiota'
                                                              ? AKIOTA_PLACE_PHOTO
                                                              : muni.slug === 'kitahiroshima'
                                                                ? KITAHIROSHIMA_PLACE_PHOTO
                                                              : muni.slug === 'osakikamijima'
                                                                ? OSAKIKAMIJIMA_PLACE_PHOTO
                                                              : muni.slug === 'sera'
                                                                ? SERA_PLACE_PHOTO
                                                              : muni.slug === 'jinseikogen'
                                                                ? JINSEIKOGEN_PLACE_PHOTO
                                                              : muni.slug === 'okayama'
                                                                ? OKAYAMA_PLACE_PHOTO
                                                                : muni.slug === 'kurashiki'
                                                                  ? KURASHIKI_PLACE_PHOTO
                                                                : muni.slug === 'tsuyama'
                                                                  ? TSUYAMA_PLACE_PHOTO
                                                          : MIMA_PLACE_PHOTO;
                                  ...
                                  : muni.slug === 'naka'
                                    ...
                                    : muni.slug === 'ayagawa'
                                      ...
                                      : muni.slug === 'imabari'
                                        ...
                                        ? loc === 'ja'
                                          ? '尾道市。千光寺、尾道水道、食。'
                                          : 'Onomichi City — Senko-ji, Onomichi Channel, food.'
                                        : muni.slug === 'fukuyama'
                                          ? loc === 'ja'
                                            ? '福山市。福山城、鞆の浦、食。'
                                            : 'Fukuyama City — Fukuyama Castle, Tomonoura, food.'
                                        : muni.slug === 'fuchu'
                                          ? loc === 'ja'
                                            ? '府中市。上下町並み、矢野岩海、食。'
                                            : 'Fuchu City, Hiroshima — Joge townscape, Yano Gankai, food.'
                                        : muni.slug === 'miyoshishi'
                                          ? loc === 'ja'
                                            ? '三次市。霧の海、もののけミュージアム、食。'
                                            : 'Miyoshi City, Hiroshima — sea of clouds, Mononoke Museum, food.'
                                        : muni.slug === 'shobara'
                                          ? loc === 'ja'
                                            ? '庄原市。備北丘陵公園、帝釈峡、食。'
                                            : 'Shobara City, Hiroshima — Bihoku Hillside Park, Taishakukyo, food.'
                                        : muni.slug === 'otake'
                                          ? loc === 'ja'
                                            ? '大竹市。下瀬美術館、亀居公園、食。'
                                            : 'Otake City, Hiroshima — Simose Art Museum, Kamei Park, food.'
                                        : muni.slug === 'higashihiroshima'
                                          ? loc === 'ja'
                                            ? '東広島市。西条酒蔵通り、三ツ城古墳、食。'
                                            : 'Higashihiroshima City — Saijo Sake Brewery Street, Mitsujo Kofun, food.'
                                        : muni.slug === 'hatsukaichi'
                                          ? loc === 'ja'
                                            ? '廿日市。厳島神社、宮島大鳥居、食。'
                                            : 'Hatsukaichi City — Itsukushima Shrine, Miyajima torii, food.'
                                        : muni.slug === 'akitakata'
                                          ? loc === 'ja'
                                            ? '安芸高田市。神楽門前湯治村、吉田郡山城跡、食。'
                                            : 'Akitakata City — Kagura Gate Village, Yoshida-Kōriyama Castle, food.'
                                        : muni.slug === 'etajima'
                                          ? loc === 'ja'
                                            ? '江田島市。旧海軍兵学校、小用港、食。'
                                            : 'Etajima City — former Naval Academy, Koyo Port, food.'
                                        : muni.slug === 'fuchucho'
                                          ? loc === 'ja'
                                            ? '府中町。水分峡森林公園、多家神社、食。'
                                            : 'Fuchu Town — Mikumari Forest Park, Take Shrine, food.'
                                        : muni.slug === 'kaita'
                                          ? loc === 'ja'
                                            ? '海田町。旧千葉家住宅、熊野神社、食。'
                                            : 'Kaita Town — former Chiba residence, Kumano Shrine, food.'
                                        : muni.slug === 'kumano'
                                          ? loc === 'ja'
                                            ? '熊野町。筆の里工房、榊山神社、食。'
                                            : 'Kumano Town — Fude-no-Sato Kobo, Sakakiyama Shrine, food.'
                                        : muni.slug === 'saka'
                                          ? loc === 'ja'
                                            ? '坂町。ベイサイドビーチ坂、八幡山八幡神社、食。'
                                            : 'Saka Town — Bayside Beach Saka, Yahata-yama Hachiman Shrine, food.'
                                        : muni.slug === 'akiota'
                                          ? loc === 'ja'
                                            ? '安芸太田町。三段峡、温井ダム、食。'
                                            : 'Akiota Town — Sandankyo Gorge, Nukui Dam, food.'
                                          : muni.slug === 'kitahiroshima'
                                            ? loc === 'ja'
                                              ? '北広島町。八幡湿原、雲月山、食。'
                                              : 'Kitahiroshima Town — Yawata Wetland, Mt. Ungetsu, food.'
                                          : muni.slug === 'osakikamijima'
                                            ? loc === 'ja'
                                              ? '大崎上島町。神峰山、瀬戸内、食。'
                                              : 'Osakikamijima Town — Mt. Kannomine, Setouchi, food.'
                                          : muni.slug === 'sera'
                                            ? loc === 'ja'
                                              ? '世羅町。せらワイナリー、世羅高原農場、食。'
                                              : 'Sera Town — Sera Winery, Sera Kogen Farm, food.'
                                          : muni.slug === 'jinseikogen'
                                            ? loc === 'ja'
                                              ? '神石高原町。帝釈峡神龍湖、ティアガルテン、食。'
                                              : 'Jinseikogen Town — Lake Shinryuko, Tiergarten, food.'
                                          : muni.slug === 'okayama'
                                            ? loc === 'ja'
                                              ? '岡山市。岡山城、後楽園、食。'
                                              : 'Okayama City — Okayama Castle, Korakuen, food.'
                                          : muni.slug === 'kurashiki'
                                            ? loc === 'ja'
                                              ? '倉敷市。美観地区、大原美術館、食。'
                                              : 'Kurashiki City — Bikan quarter, Ohara Museum, food.'
                                          : muni.slug === 'tsuyama'
                                            ? loc === 'ja'
                                              ? '津山市。津山城、衆楽園、食。'
                                              : 'Tsuyama City — Tsuyama Castle, Shurakuen, food.'
                                        : loc === 'ja'
  ...
  return (
    <>
      ...
      <p className="note">
        ...
        <details className="facts-fold">
          <summary>{isJa ? '尾道市の基礎情報' : 'Onomichi City facts'}</summary>
          <table className="facts">
            <tbody>
              <tr>
                <th scope="row">{isJa ? '名称' : 'Name'}</th>
                <td>
              {ONOMICHI.nameJa} / {ONOMICHI.nameEn}（{ONOMICHI.reading}）
                </td>
              </tr>
              <tr>
                <th scope="row">{isJa ? '都道府県' : 'Prefecture'}</th>
                <td>
              <Link href="/hiroshima">{isJa ? ONOMICHI.prefectureJa : ONOMICHI.prefectureEn}</Link>
                </td>
              </tr>
              <tr>
                <th scope="row">JIS</th>
                <td>
              <strong>{ONOMICHI.jis}</strong>
                </td>
              </tr>
              <tr>
                <th scope="row">JLIS</th>
              ...
              <tr>
                <th scope="row">{isJa ? '役場' : 'Hall'}</th>
                <td>
              〒{ONOMICHI.hall.postalCode} {isJa ? ONOMICHI.hall.addressJa : ONOMICHI.hall.addressEn}
              {' · '}
              {ONOMICHI.hall.phone} · <a href={ONOMICHI.sameAs}>sameAs {ONOMICHI.sameAs}</a>
                </td>
              </tr>
            </tbody>
          </table>
          <p className="facts-sources">
        <a href={ONOMICHI.sources.hall}>{isJa ? '市役所案内' : 'Hall guide'}</a>
        {' · '}
        <a href={ONOMICHI.sources.home}>{isJa ? '市ホームページ' : 'City homepage'}</a>
        {' · '}
        <a href={ONOMICHI.sources.tabelogCity}>{isJa ? '食べログ尾道市' : 'Tabelog Onomichi'}</a>
          </p>
          <p className="facts-note">
          {isJa
          ? `数字のアクセス日は ${ONOMICHI.sources.accessed}。人口は未掲載（出典ページを混ぜません）。広島県5つ目のLIVEハブ。`
          : `Figures accessed ${ONOMICHI.sources.accessed}. Population is unpublished (universes are not mixed). Fifth LIVE Hiroshima hub.`}
          </p>
        </details>
        ...
        <details className="facts-fold">
          <summary>{isJa ? '福山市の基礎情報' : 'Fukuyama City facts'}</summary>
          <table className="facts">
            <tbody>
              <tr>
                <th scope="row">{isJa ? '名称' : 'Name'}</th>
                <td>
              {FUKUYAMA.nameJa} / {FUKUYAMA.nameEn}（{FUKUYAMA.reading}）
                </td>
              </tr>
              <tr>
                <th scope="row">{isJa ? '都道府県' : 'Prefecture'}</th>
                <td>
              <Link href="/hiroshima">{isJa ? FUKUYAMA.prefectureJa : FUKUYAMA.prefectureEn}</Link>
                </td>
              </tr>
              <tr>
                <th scope="row">JIS</th>
                <td>
              <strong>{FUKUYAMA.jis}</strong>
                </td>
              </tr>
              <tr>
                <th scope="row">JLIS</th>
              ...
              <tr>
                <th scope="row">{isJa ? '役場' : 'Hall'}</th>
                <td>
              〒{FUKUYAMA.hall.postalCode} {isJa ? FUKUYAMA.hall.addressJa : FUKUYAMA.hall.addressEn}
              {' · '}
              {FUKUYAMA.hall.phone} · <a href={FUKUYAMA.sameAs}>sameAs {FUKUYAMA.sameAs}</a>
                </td>
              </tr>
            </tbody>
          </table>
          <p className="facts-sources">
        <a href={FUKUYAMA.sources.hall}>{isJa ? '市役所案内' : 'Hall guide'}</a>
        {' · '}
        <a href={FUKUYAMA.sources.home}>{isJa ? '市ホームページ' : 'City homepage'}</a>
        {' · '}
        <a href={FUKUYAMA.sources.tabelogCity}>{isJa ? '食べログ福山市' : 'Tabelog Fukuyama'}</a>
          </p>
          <p className="facts-note">
          {isJa
          ? `数字のアクセス日は ${FUKUYAMA.sources.accessed}。人口は未掲載（出典ページを混ぜません）。広島県6つ目のLIVEハブ。`
          : `Figures accessed ${FUKUYAMA.sources.accessed}. Population is unpublished (universes are not mixed). Sixth LIVE Hiroshima hub.`}
          </p>
        </details>
        ...
        <details className="facts-fold">
          <summary>{isJa ? '府中市の基礎情報' : 'Fuchu City facts'}</summary>
          <table className="facts">
            <tbody>
              <tr>
                <th scope="row">{isJa ? '名称' : 'Name'}</th>
                <td>
              {FUCHU.nameJa} / {FUCHU.nameEn}（{FUCHU.reading}）
                </td>
              </tr>
              <tr>
                <th scope="row">{isJa ? '都道府県' : 'Prefecture'}</th>
                <td>
              <Link href="/hiroshima">{isJa ? FUCHU.prefectureJa : FUCHU.prefectureEn}</Link>
                </td>
              </tr>
              <tr>
                <th scope="row">JIS</th>
                <td>
              <strong>{FUCHU.jis}</strong>
                </td>
              </tr>
              <tr>
                <th scope="row">JLIS</th>
              ...
              <tr>
                <th scope="row">{isJa ? '役場' : 'Hall'}</th>
                <td>
              〒{FUCHU.hall.postalCode} {isJa ? FUCHU.hall.addressJa : FUCHU.hall.addressEn}
              {' · '}
              {FUCHU.hall.phone} · <a href={FUCHU.sameAs}>sameAs {FUCHU.sameAs}</a>
                </td>
              </tr>
            </tbody>
          </table>
          <p className="facts-sources">
        <a href={FUCHU.sources.hall}>{isJa ? '市役所案内' : 'Hall guide'}</a>
        {' · '}
        <a href={FUCHU.sources.home}>{isJa ? '市ホームページ' : 'City homepage'}</a>
        {' · '}
        <a href={FUCHU.sources.kanko}>{isJa ? '観光協会' : 'Tourism association'}</a>
        {' · '}
        <a href={FUCHU.sources.tabelogCity}>{isJa ? '食べログ府中市' : 'Tabelog Fuchu'}</a>
          </p>
          <p className="facts-note">
          {isJa
          ? `数字のアクセス日は ${FUCHU.sources.accessed}。人口は未掲載（出典ページを混ぜません）。広島県7つ目のLIVEハブ。slug fuchu＝広島県府中市（東京府中市・府中町と別）。`
          : `Figures accessed ${FUCHU.sources.accessed}. Population is unpublished (universes are not mixed). Seventh LIVE Hiroshima hub. Slug fuchu = Fuchu City, Hiroshima (not Tokyo Fuchu / Fuchu Town).`}
          </p>
        </details>

) : town.slug === 'miyoshishi' ? (
        <details className="facts">
          <summary>{isJa ? '三次市の基礎情報' : 'Miyoshi City facts'}</summary>
          <table>
            <tbody>
              <tr>
                <th>{isJa ? '名称' : 'Name'}</th>
                <td>
              {MIYOSHISHI.nameJa} / {MIYOSHISHI.nameEn}（{MIYOSHISHI.reading}）
                </td>
              </tr>
              <tr>
                <th>{isJa ? '都道府県' : 'Prefecture'}</th>
                <td>
              <Link href="/hiroshima">{isJa ? MIYOSHISHI.prefectureJa : MIYOSHISHI.prefectureEn}</Link>
                </td>
              </tr>
              <tr>
                <th>JIS</th>
                <td>
              <strong>{MIYOSHISHI.jis}</strong>
                </td>
              </tr>
              <tr>
                <th>JLIS</th>
                <td>{MIYOSHISHI.jlis}</td>
              </tr>
              <tr>
                <th>{isJa ? '市役所' : 'City hall'}</th>
                <td>
              〒{MIYOSHISHI.hall.postalCode} {isJa ? MIYOSHISHI.hall.addressJa : MIYOSHISHI.hall.addressEn}
                  <br />
              {MIYOSHISHI.hall.phone} · <a href={MIYOSHISHI.sameAs}>sameAs {MIYOSHISHI.sameAs}</a>
                </td>
              </tr>
            </tbody>
          </table>
          <p className="facts-links">
        <a href={MIYOSHISHI.sources.hall}>{isJa ? '市役所案内' : 'Hall guide'}</a>
            {' · '}
        <a href={MIYOSHISHI.sources.home}>{isJa ? '市ホームページ' : 'City homepage'}</a>
            {' · '}
        <a href={MIYOSHISHI.sources.kanko}>{isJa ? '観光協会' : 'Tourism association'}</a>
            {' · '}
        <a href={MIYOSHISHI.sources.tabelogCity}>{isJa ? '食べログ三次市' : 'Tabelog Miyoshi'}</a>
          </p>
          <p className="facts-note">
            {isJa
          ? `数字のアクセス日は ${MIYOSHISHI.sources.accessed}。人口は未掲載（出典ページを混ぜません）。広島県8つ目のLIVEハブ。slug miyoshishi＝広島県三次市（徳島県三好市と別）。`
          : `Figures accessed ${MIYOSHISHI.sources.accessed}. Population is unpublished (universes are not mixed). Eighth LIVE Hiroshima hub. Slug miyoshishi = Miyoshi City, Hiroshima (not Tokushima Miyoshi).`}
          </p>
        </details>
        ...
        <details className="facts">
          <summary>{isJa ? '庄原市の基礎情報' : 'Shobara City facts'}</summary>
          <table>
            <tbody>
              <tr>
                <th>{isJa ? '名称' : 'Name'}</th>
                <td>
              {SHOBARA.nameJa} / {SHOBARA.nameEn}（{SHOBARA.reading}）
                </td>
              </tr>
              <tr>
                <th>{isJa ? '都道府県' : 'Prefecture'}</th>
                <td>
              <Link href="/hiroshima">{isJa ? SHOBARA.prefectureJa : SHOBARA.prefectureEn}</Link>
                </td>
              </tr>
              <tr>
                <th>JIS</th>
                <td>
              <strong>{SHOBARA.jis}</strong>
                </td>
              </tr>
              <tr>
                <th>JLIS</th>
              ...
              <tr>
                <th>{isJa ? '市役所' : 'City hall'}</th>
                <td>
              〒{SHOBARA.hall.postalCode} {isJa ? SHOBARA.hall.addressJa : SHOBARA.hall.addressEn}
                  <br />
              {SHOBARA.hall.phone} · <a href={SHOBARA.sameAs}>sameAs {SHOBARA.sameAs}</a>
                </td>
              </tr>
            </tbody>
          </table>
          <p className="facts-links">
        <a href={SHOBARA.sources.hall}>{isJa ? '市役所案内' : 'Hall guide'}</a>
            {' · '}
        <a href={SHOBARA.sources.home}>{isJa ? '市ホームページ' : 'City homepage'}</a>
            {' · '}
        <a href={SHOBARA.sources.kanko}>{isJa ? '観光ナビ' : 'Tourism nav'}</a>
            {' · '}
        <a href={SHOBARA.sources.tabelogCity}>{isJa ? '食べログ庄原市' : 'Tabelog Shobara'}</a>
          </p>
          <p className="facts-note">
            {isJa
          ? `数字のアクセス日は ${SHOBARA.sources.accessed}。人口は未掲載（出典ページを混ぜません）。広島県9つ目のLIVEハブ。`
          : `Figures accessed ${SHOBARA.sources.accessed}. Population is unpublished (universes are not mixed). Ninth LIVE Hiroshima hub.`}
          </p>
        </details>
        ...
        <details className="facts">
          <summary>{isJa ? '大竹市の基礎情報' : 'Otake City facts'}</summary>
          <table>
            <tbody>
              <tr>
                <th>{isJa ? '名称' : 'Name'}</th>
                <td>
              {OTAKE.nameJa} / {OTAKE.nameEn}（{OTAKE.reading}）
                </td>
              </tr>
              <tr>
                <th>{isJa ? '都道府県' : 'Prefecture'}</th>
                <td>
              <Link href="/hiroshima">{isJa ? OTAKE.prefectureJa : OTAKE.prefectureEn}</Link>
                </td>
              </tr>
              <tr>
                <th>JIS</th>
                <td>
              <strong>{OTAKE.jis}</strong>
                </td>
              </tr>
              <tr>
                <th>JLIS</th>
              ...
              <tr>
                <th>{isJa ? '市役所' : 'City hall'}</th>
                <td>
              〒{OTAKE.hall.postalCode} {isJa ? OTAKE.hall.addressJa : OTAKE.hall.addressEn}
                  <br />
              {OTAKE.hall.phone} · <a href={OTAKE.sameAs}>sameAs {OTAKE.sameAs}</a>
                </td>
              </tr>
            </tbody>
          </table>
          <p className="facts-links">
        <a href={OTAKE.sources.hall}>{isJa ? '市役所案内' : 'Hall guide'}</a>
            {' · '}
        <a href={OTAKE.sources.home}>{isJa ? '市ホームページ' : 'City homepage'}</a>
            {' · '}
        <a href={OTAKE.sources.kanko}>{isJa ? '観光ナビ' : 'Tourism nav'}</a>
            {' · '}
        <a href={OTAKE.sources.tabelogCity}>{isJa ? '食べログ大竹市' : 'Tabelog Otake'}</a>
          </p>
          <p className="facts-note">
            {isJa
          ? `数字のアクセス日は ${OTAKE.sources.accessed}。人口は未掲載（出典ページを混ぜません）。広島県10つ目のLIVEハブ。`
          : `Figures accessed ${OTAKE.sources.accessed}. Population is unpublished (universes are not mixed). Tenth LIVE Hiroshima hub.`}
          </p>
        </details>


) : town.slug === 'higashihiroshima' ? (
        <details className="facts">
          <summary>{isJa ? '東広島市の基礎情報' : 'Higashihiroshima City facts'}</summary>
          <table>
            <tbody>
              <tr>
                <th>{isJa ? '名称' : 'Name'}</th>
                <td>
              {HIGASHIHIROSHIMA.nameJa} / {HIGASHIHIROSHIMA.nameEn}（{HIGASHIHIROSHIMA.reading}）
                </td>
              </tr>
              <tr>
                <th>{isJa ? '都道府県' : 'Prefecture'}</th>
                <td>
              <Link href="/hiroshima">{isJa ? HIGASHIHIROSHIMA.prefectureJa : HIGASHIHIROSHIMA.prefectureEn}</Link>
                </td>
              </tr>
              <tr>
                <th>JIS</th>
                <td>
              <strong>{HIGASHIHIROSHIMA.jis}</strong>
                </td>
              </tr>
              <tr>
                <th>JLIS</th>
                <td>{HIGASHIHIROSHIMA.jlis}</td>
              </tr>
              <tr>
                <th>{isJa ? '市役所' : 'City hall'}</th>
                <td>
              〒{HIGASHIHIROSHIMA.hall.postalCode} {isJa ? HIGASHIHIROSHIMA.hall.addressJa : HIGASHIHIROSHIMA.hall.addressEn}
                  <br />
              {HIGASHIHIROSHIMA.hall.phone} · <a href={HIGASHIHIROSHIMA.sameAs}>sameAs {HIGASHIHIROSHIMA.sameAs}</a>
                </td>
              </tr>
            </tbody>
          </table>
          <p className="facts-links">
        <a href={HIGASHIHIROSHIMA.sources.hall}>{isJa ? '市役所案内' : 'Hall guide'}</a>
            {' · '}
        <a href={HIGASHIHIROSHIMA.sources.home}>{isJa ? '市ホームページ' : 'City homepage'}</a>
            {' · '}
        <a href={HIGASHIHIROSHIMA.sources.kanko}>{isJa ? '観光ナビ' : 'Tourism nav'}</a>
            {' · '}
        <a href={HIGASHIHIROSHIMA.sources.tabelogCity}>{isJa ? '食べログ東広島市' : 'Tabelog Higashihiroshima'}</a>
          </p>
          <p className="facts-note">
            {isJa
          ? `数字のアクセス日は ${HIGASHIHIROSHIMA.sources.accessed}。人口は未掲載（出典ページを混ぜません）。広島県11つ目のLIVEハブ。`
          : `Figures accessed ${HIGASHIHIROSHIMA.sources.accessed}. Population is unpublished (universes are not mixed). Eleventh LIVE Hiroshima hub.`}
          </p>
        </details>
        ...
        <details className="facts">
          <summary>{isJa ? '府中町の基礎情報' : 'Fuchu Town facts'}</summary>
          <table>
            <tbody>
              <tr>
                <th>{isJa ? '名称' : 'Name'}</th>
                <td>
              {FUCHUCHO.nameJa} / {FUCHUCHO.nameEn}（{FUCHUCHO.reading}）
                </td>
              </tr>
              <tr>
                <th>{isJa ? '都道府県' : 'Prefecture'}</th>
                <td>
              <Link href="/hiroshima">{isJa ? FUCHUCHO.prefectureJa : FUCHUCHO.prefectureEn}</Link>
                </td>
              </tr>
              <tr>
                <th>JIS</th>
                <td>
              <strong>{FUCHUCHO.jis}</strong>
                </td>
              </tr>
              <tr>
                <th>JLIS</th>
              ...
              <tr>
                <th>{isJa ? '役場' : 'Town hall'}</th>
                <td>
              〒{FUCHUCHO.hall.postalCode} {isJa ? FUCHUCHO.hall.addressJa : FUCHUCHO.hall.addressEn}
                  <br />
              {FUCHUCHO.hall.phone} · <a href={FUCHUCHO.sameAs}>sameAs {FUCHUCHO.sameAs}</a>
                </td>
              </tr>
            </tbody>
          </table>
          <p className="facts-links">
        <a href={FUCHUCHO.sources.hall}>{isJa ? '役場案内' : 'Hall guide'}</a>
            {' · '}
        <a href={FUCHUCHO.sources.home}>{isJa ? '町ホームページ' : 'Town homepage'}</a>
            {' · '}
        <a href={FUCHUCHO.sources.kanko}>{isJa ? '観光ナビ' : 'Tourism nav'}</a>
            {' · '}
        <a href={FUCHUCHO.sources.tabelogCity}>{isJa ? '食べログ府中町' : 'Tabelog Fuchu Town'}</a>
          </p>
          <p className="facts-note">
            {isJa
          ? `数字のアクセス日は ${FUCHUCHO.sources.accessed}。人口は未掲載（出典ページを混ぜません）。広島県15つ目のLIVEハブ。府中市（fuchu）とは別。`
          : `Figures accessed ${FUCHUCHO.sources.accessed}. Population is unpublished (universes are not mixed). Fifteenth LIVE Hiroshima hub. Distinct from Fuchu City (fuchu).`}
          </p>
        </details>
        ...
        <details className="facts">
          <summary>{isJa ? '海田町の基礎情報' : 'Kaita facts'}</summary>
          <table>
            <tbody>
              <tr>
                <th>{isJa ? '名称' : 'Name'}</th>
                <td>
              {KAITA.nameJa} / {KAITA.nameEn}（{KAITA.reading}）
                </td>
              </tr>
              <tr>
                <th>{isJa ? '都道府県' : 'Prefecture'}</th>
                <td>
              <Link href="/hiroshima">{isJa ? KAITA.prefectureJa : KAITA.prefectureEn}</Link>
                </td>
              </tr>
              <tr>
                <th>JIS</th>
                <td>
              <strong>{KAITA.jis}</strong>
                </td>
              </tr>
              <tr>
                <th>JLIS</th>
              ...
              <tr>
                <th>{isJa ? '役場' : 'Town hall'}</th>
                <td>
              〒{KAITA.hall.postalCode} {isJa ? KAITA.hall.addressJa : KAITA.hall.addressEn}
                  <br />
              {KAITA.hall.phone} · <a href={KAITA.sameAs}>sameAs {KAITA.sameAs}</a>
                </td>
              </tr>
            </tbody>
          </table>
          <p className="facts-links">
        <a href={KAITA.sources.hall}>{isJa ? '役場案内' : 'Hall guide'}</a>
            {' · '}
        <a href={KAITA.sources.home}>{isJa ? '町ホームページ' : 'Town homepage'}</a>
            {' · '}
        <a href={KAITA.sources.kanko}>{isJa ? '観光ナビ' : 'Tourism nav'}</a>
            {' · '}
        <a href={KAITA.sources.tabelogCity}>{isJa ? '食べログ海田町' : 'Tabelog Kaita'}</a>
          </p>
          <p className="facts-note">
            {isJa
          ? `数字のアクセス日は ${KAITA.sources.accessed}。人口は未掲載（出典ページを混ぜません）。広島県16つ目のLIVEハブ。`
          : `Figures accessed ${KAITA.sources.accessed}. Population is unpublished (universes are not mixed). Sixteenth LIVE Hiroshima hub.`}
          </p>
        </details>
        ...
        <details className="facts">
          <summary>{isJa ? '熊野町の基礎情報' : 'Kumano facts'}</summary>
          <table>
            <tbody>
              <tr>
                <th>{isJa ? '名称' : 'Name'}</th>
                <td>
              {KUMANO.nameJa} / {KUMANO.nameEn}（{KUMANO.reading}）
                </td>
              </tr>
              <tr>
                <th>{isJa ? '都道府県' : 'Prefecture'}</th>
                <td>
              <Link href="/hiroshima">{isJa ? KUMANO.prefectureJa : KUMANO.prefectureEn}</Link>
                </td>
              </tr>
              <tr>
                <th>JIS</th>
                <td>
              <strong>{KUMANO.jis}</strong>
                </td>
              </tr>
              <tr>
                <th>JLIS</th>
              ...
              <tr>
                <th>{isJa ? '役場' : 'Town hall'}</th>
                <td>
              〒{KUMANO.hall.postalCode} {isJa ? KUMANO.hall.addressJa : KUMANO.hall.addressEn}
                  <br />
              {KUMANO.hall.phone} · <a href={KUMANO.sameAs}>sameAs {KUMANO.sameAs}</a>
                </td>
              </tr>
            </tbody>
          </table>
          <p className="facts-links">
        <a href={KUMANO.sources.hall}>{isJa ? '役場案内' : 'Hall guide'}</a>
            {' · '}
        <a href={KUMANO.sources.home}>{isJa ? '町ホームページ' : 'Town homepage'}</a>
            {' · '}
        <a href={KUMANO.sources.kanko}>{isJa ? '観光ナビ' : 'Tourism nav'}</a>
            {' · '}
        <a href={KUMANO.sources.tabelogCity}>{isJa ? '食べログ熊野町' : 'Tabelog Kumano'}</a>
          </p>
          <p className="facts-note">
            {isJa
          ? `数字のアクセス日は ${KUMANO.sources.accessed}。人口は未掲載（出典ページを混ぜません）。広島県17つ目のLIVEハブ。和歌山・三重の熊野とは別。`
          : `Figures accessed ${KUMANO.sources.accessed}. Population is unpublished (universes are not mixed). Seventeenth LIVE Hiroshima hub. Distinct from Wakayama/Mie Kumano.`}
          </p>
        </details>
        ...
        <details className="facts">
          <summary>{isJa ? '坂町の基礎情報' : 'Saka facts'}</summary>
          <table>
            <tbody>
              <tr>
                <th>{isJa ? '名称' : 'Name'}</th>
                <td>
              {SAKA.nameJa} / {SAKA.nameEn}（{SAKA.reading}）
                </td>
              </tr>
              <tr>
                <th>{isJa ? '都道府県' : 'Prefecture'}</th>
                <td>
              <Link href="/hiroshima">{isJa ? SAKA.prefectureJa : SAKA.prefectureEn}</Link>
                </td>
              </tr>
              <tr>
                <th>JIS</th>
                <td>
              <strong>{SAKA.jis}</strong>
                </td>
              </tr>
              <tr>
                <th>JLIS</th>
              ...
              <tr>
                <th>{isJa ? '役場' : 'Town hall'}</th>
                <td>
              〒{SAKA.hall.postalCode} {isJa ? SAKA.hall.addressJa : SAKA.hall.addressEn}
                  <br />
              {SAKA.hall.phone} · <a href={SAKA.sameAs}>sameAs {SAKA.sameAs}</a>
                </td>
              </tr>
            </tbody>
          </table>
          <p className="facts-links">
        <a href={SAKA.sources.hall}>{isJa ? '役場案内' : 'Hall guide'}</a>
            {' · '}
        <a href={SAKA.sources.home}>{isJa ? '町ホームページ' : 'Town homepage'}</a>
            {' · '}
        <a href={SAKA.sources.kanko}>{isJa ? '観光ナビ' : 'Tourism nav'}</a>
            {' · '}
        <a href={SAKA.sources.tabelogCity}>{isJa ? '食べログ坂町' : 'Tabelog Saka'}</a>
          </p>
          <p className="facts-note">
            {isJa
          ? `数字のアクセス日は ${SAKA.sources.accessed}。人口は未掲載（出典ページを混ぜません）。広島県18つ目のLIVEハブ。坂出市など他の「坂」とは別。`
          : `Figures accessed ${SAKA.sources.accessed}. Population is unpublished (universes are not mixed). Eighteenth LIVE Hiroshima hub. Distinct from Sakaide and other Saka names.`}
          </p>
        </details>
        ...
        <details className="facts">
          <summary>{isJa ? '安芸太田町の基礎情報' : 'Akiota facts'}</summary>
          <table>
            <tbody>
              <tr>
                <th>{isJa ? '名称' : 'Name'}</th>
                <td>
              {AKIOTA.nameJa} / {AKIOTA.nameEn}（{AKIOTA.reading}）
                </td>
              </tr>
              <tr>
                <th>{isJa ? '都道府県' : 'Prefecture'}</th>
                <td>
              <Link href="/hiroshima">{isJa ? AKIOTA.prefectureJa : AKIOTA.prefectureEn}</Link>
                </td>
              </tr>
              <tr>
                <th>JIS</th>
                <td>
              <strong>{AKIOTA.jis}</strong>
                </td>
              </tr>
              <tr>
                <th>JLIS</th>
              ...
              <tr>
                <th>{isJa ? '役場' : 'Town hall'}</th>
                <td>
              〒{AKIOTA.hall.postalCode} {isJa ? AKIOTA.hall.addressJa : AKIOTA.hall.addressEn}
                  <br />
              {AKIOTA.hall.phone} · <a href={AKIOTA.sameAs}>sameAs {AKIOTA.sameAs}</a>
                </td>
              </tr>
            </tbody>
          </table>
          <p className="facts-links">
        <a href={AKIOTA.sources.hall}>{isJa ? '役場案内' : 'Hall guide'}</a>
            {' · '}
        <a href={AKIOTA.sources.home}>{isJa ? '町ホームページ' : 'Town homepage'}</a>
            {' · '}
        <a href={AKIOTA.sources.kanko}>{isJa ? '観光ナビ' : 'Tourism nav'}</a>
            {' · '}
        <a href={AKIOTA.sources.tabelogCity}>{isJa ? '食べログ安芸太田町' : 'Tabelog Akiota'}</a>
          </p>
          <p className="facts-note">
            {isJa
          ? `数字のアクセス日は ${AKIOTA.sources.accessed}。人口は未掲載（出典ページを混ぜません）。広島県19つ目のLIVEハブ。安芸高田市とは別。`
          : `Figures accessed ${AKIOTA.sources.accessed}. Population is unpublished (universes are not mixed). Nineteenth LIVE Hiroshima hub. Distinct from Akitakata City.`}
          </p>
        </details>



) : town.slug === 'kitahiroshima' ? (
        <details className="facts">
          <summary>{isJa ? '北広島町の基礎情報' : 'Kitahiroshima facts'}</summary>
          <table>
            <tbody>
              <tr>
                <th>{isJa ? '町名' : 'Name'}</th>
                <td>
              {KITAHIROSHIMA.nameJa} / {KITAHIROSHIMA.nameEn}（{KITAHIROSHIMA.reading}）
                </td>
              </tr>
              <tr>
                <th>{isJa ? '都道府県' : 'Prefecture'}</th>
                <td>
              <Link href="/hiroshima">{isJa ? KITAHIROSHIMA.prefectureJa : KITAHIROSHIMA.prefectureEn}</Link>
                </td>
              </tr>
              <tr>
                <th>JIS</th>
                <td>
              <strong>{KITAHIROSHIMA.jis}</strong>
                </td>
              </tr>
              <tr>
                <th>JLIS</th>
                <td>{KITAHIROSHIMA.jlis}</td>
              </tr>
              <tr>
                <th>{isJa ? '役場' : 'Town hall'}</th>
                <td>
              〒{KITAHIROSHIMA.hall.postalCode} {isJa ? KITAHIROSHIMA.hall.addressJa : KITAHIROSHIMA.hall.addressEn}
              ·
              {KITAHIROSHIMA.hall.phone} · <a href={KITAHIROSHIMA.sameAs}>sameAs {KITAHIROSHIMA.sameAs}</a>
                </td>
              </tr>
            </tbody>
          </table>
          <p>
        <a href={KITAHIROSHIMA.sources.hall}>{isJa ? '役場案内' : 'Hall guide'}</a>
        ·
        <a href={KITAHIROSHIMA.sources.home}>{isJa ? '町ホームページ' : 'Town homepage'}</a>
        ·
        <a href={KITAHIROSHIMA.sources.kanko}>{isJa ? '観光ナビ' : 'Tourism nav'}</a>
        ·
        <a href={KITAHIROSHIMA.sources.tabelogCity}>{isJa ? '食べログ北広島町' : 'Tabelog Kitahiroshima'}</a>
          </p>
          <p className="facts-note">
          {isJa
          ? `数字のアクセス日は ${KITAHIROSHIMA.sources.accessed}。人口は未掲載（出典ページを混ぜません）。広島県20つ目のLIVEハブ。北海道北広島市とは別。`
          : `Figures accessed ${KITAHIROSHIMA.sources.accessed}. Population is unpublished (universes are not mixed). Twentieth LIVE Hiroshima hub. Distinct from Kitahiroshima City, Hokkaido.`}
          </p>
        </details>
        ...
        <details className="facts">
          <summary>{isJa ? '岡山市の基礎情報' : 'Okayama City facts'}</summary>
          <table>
            <tbody>
              <tr>
                <th>{isJa ? '市名' : 'Name'}</th>
                <td>
              {OKAYAMA.nameJa} / {OKAYAMA.nameEn}（{OKAYAMA.reading}）
                </td>
              </tr>
              <tr>
                <th>{isJa ? '都道府県' : 'Prefecture'}</th>
                <td>
              <Link href="/okayama">{isJa ? OKAYAMA.prefectureJa : OKAYAMA.prefectureEn}</Link>
                </td>
              </tr>
              <tr>
                <th>JIS</th>
                <td>
              <strong>{OKAYAMA.jis}</strong>
                </td>
              </tr>
              <tr>
                <th>JLIS</th>
              ...
              <tr>
                <th>{isJa ? '市役所' : 'City hall'}</th>
                <td>
              〒{OKAYAMA.hall.postalCode} {isJa ? OKAYAMA.hall.addressJa : OKAYAMA.hall.addressEn}
              ·
              {OKAYAMA.hall.phone} · <a href={OKAYAMA.sameAs}>sameAs {OKAYAMA.sameAs}</a>
                </td>
              </tr>
            </tbody>
          </table>
          <p>
        <a href={OKAYAMA.sources.hall}>{isJa ? '市役所案内' : 'Hall guide'}</a>
        ·
        <a href={OKAYAMA.sources.home}>{isJa ? '市ホームページ' : 'City homepage'}</a>
        ·
        <a href={OKAYAMA.sources.kanko}>{isJa ? '公式観光' : 'Official sightseeing'}</a>
        ·
        <a href={OKAYAMA.sources.castle}>{isJa ? '岡山城' : 'Okayama Castle'}</a>
        ·
        <a href={OKAYAMA.sources.tabelogCity}>{isJa ? '食べログ岡山市' : 'Tabelog Okayama'}</a>
          </p>
          <p className="facts-note">
          {isJa
          ? `数字のアクセス日は ${OKAYAMA.sources.accessed}。人口は未掲載（出典ページを混ぜません）。岡山県1つ目のLIVEハブ。`
          : `Figures accessed ${OKAYAMA.sources.accessed}. Population is unpublished (universes are not mixed). First LIVE Okayama hub.`}
          </p>
        </details>
        ...
        <details className="facts">
          <summary>{isJa ? '倉敷市の基礎情報' : 'Kurashiki City facts'}</summary>
          <table>
            <tbody>
              <tr>
                <th>{isJa ? '市名' : 'Name'}</th>
                <td>
              {KURASHIKI.nameJa} / {KURASHIKI.nameEn}（{KURASHIKI.reading}）
                </td>
              </tr>
              <tr>
                <th>{isJa ? '都道府県' : 'Prefecture'}</th>
                <td>
              <Link href="/okayama">{isJa ? KURASHIKI.prefectureJa : KURASHIKI.prefectureEn}</Link>
                </td>
              </tr>
              <tr>
                <th>JIS</th>
                <td>
              <strong>{KURASHIKI.jis}</strong>
                </td>
              </tr>
              <tr>
                <th>JLIS</th>
                <td>{KURASHIKI.jlis}</td>
              </tr>
              <tr>
                <th>{isJa ? '市役所' : 'City hall'}</th>
                <td>
              〒{KURASHIKI.hall.postalCode} {isJa ? KURASHIKI.hall.addressJa : KURASHIKI.hall.addressEn}
              ·
              {KURASHIKI.hall.phone} · <a href={KURASHIKI.sameAs}>sameAs {KURASHIKI.sameAs}</a>
                </td>
              </tr>
            </tbody>
          </table>
          <p>
        <a href={KURASHIKI.sources.hall}>{isJa ? '市役所案内' : 'Hall guide'}</a>
        ·
        <a href={KURASHIKI.sources.home}>{isJa ? '市ホームページ' : 'City homepage'}</a>
        ·
        <a href={KURASHIKI.sources.kanko}>{isJa ? '公式観光' : 'Official sightseeing'}</a>
        ·
        <a href={KURASHIKI.sources.bikan}>{isJa ? '美観地区' : 'Bikan quarter'}</a>
        ·
        <a href={KURASHIKI.sources.tabelogCity}>{isJa ? '食べログ倉敷市' : 'Tabelog Kurashiki'}</a>
          </p>
          <p className="facts-note">
          {isJa
          ? `数字のアクセス日は ${KURASHIKI.sources.accessed}。人口は未掲載（出典ページを混ぜません）。岡山県2つ目のLIVEハブ。`
          : `Figures accessed ${KURASHIKI.sources.accessed}. Population is unpublished (universes are not mixed). Second LIVE Okayama hub.`}
          </p>
        </details>
        ...
        <details className="facts">
          <summary>{isJa ? '津山市の基礎情報' : 'Tsuyama City facts'}</summary>
          <table>
            <tbody>
              <tr>
                <th>{isJa ? '市名' : 'Name'}</th>
                <td>
              {TSUYAMA.nameJa} / {TSUYAMA.nameEn}（{TSUYAMA.reading}）
                </td>
              </tr>
              <tr>
                <th>{isJa ? '都道府県' : 'Prefecture'}</th>
                <td>
              <Link href="/okayama">{isJa ? TSUYAMA.prefectureJa : TSUYAMA.prefectureEn}</Link>
                </td>
              </tr>
              <tr>
                <th>JIS</th>
                <td>
              <strong>{TSUYAMA.jis}</strong>
                </td>
              </tr>
              <tr>
                <th>JLIS</th>
              ...
              <tr>
                <th>{isJa ? '市役所' : 'City hall'}</th>
                <td>
              〒{TSUYAMA.hall.postalCode} {isJa ? TSUYAMA.hall.addressJa : TSUYAMA.hall.addressEn}
              ·
              {TSUYAMA.hall.phone} · <a href={TSUYAMA.sameAs}>sameAs {TSUYAMA.sameAs}</a>
                </td>
              </tr>
            </tbody>
          </table>
          <p>
        <a href={TSUYAMA.sources.hall}>{isJa ? '市役所案内' : 'Hall guide'}</a>
        ·
        <a href={TSUYAMA.sources.home}>{isJa ? '市ホームページ' : 'City homepage'}</a>
        ·
        <a href={TSUYAMA.sources.kanko}>{isJa ? '公式観光' : 'Official sightseeing'}</a>
        ·
        <a href={TSUYAMA.sources.castle}>{isJa ? '津山城' : 'Tsuyama Castle'}</a>
        ·
        <a href={TSUYAMA.sources.tabelogCity}>{isJa ? '食べログ津山市' : 'Tabelog Tsuyama'}</a>
          </p>
          <p className="facts-note">
          {isJa
          ? `数字のアクセス日は ${TSUYAMA.sources.accessed}。人口は未掲載（出典ページを混ぜません）。岡山県3つ目のLIVEハブ。`
          : `Figures accessed ${TSUYAMA.sources.accessed}. Population is unpublished (universes are not mixed). Third LIVE Okayama hub.`}
          </p>
        </details>



) : town.slug === 'jinseikogen' ? (
        <details className="facts">
          <summary>{isJa ? '神石高原町の基礎情報' : 'Jinseikogen facts'}</summary>
          <table>
            <tbody>
              <tr>
                <th>{isJa ? '町名' : 'Name'}</th>
                <td>
              {JINSEIKOGEN.nameJa} / {JINSEIKOGEN.nameEn}（{JINSEIKOGEN.reading}）
                </td>
              </tr>
              <tr>
                <th>{isJa ? '都道府県' : 'Prefecture'}</th>
                <td>
              <Link href="/hiroshima">{isJa ? JINSEIKOGEN.prefectureJa : JINSEIKOGEN.prefectureEn}</Link>
                </td>
              </tr>
              <tr>
                <th>JIS</th>
                <td>
              <strong>{JINSEIKOGEN.jis}</strong>
                </td>
              </tr>
              <tr>
                <th>JLIS</th>
                <td>{JINSEIKOGEN.jlis}</td>
              </tr>
              <tr>
                <th>{isJa ? '役場' : 'Town hall'}</th>
                <td>
              〒{JINSEIKOGEN.hall.postalCode} {isJa ? JINSEIKOGEN.hall.addressJa : JINSEIKOGEN.hall.addressEn}
              ·
              {JINSEIKOGEN.hall.phone} · <a href={JINSEIKOGEN.sameAs}>sameAs {JINSEIKOGEN.sameAs}</a>
                </td>
              </tr>
            </tbody>
          </table>
          <p>
        <a href={JINSEIKOGEN.sources.hall}>{isJa ? '役場案内' : 'Hall guide'}</a>
        ·
        <a href={JINSEIKOGEN.sources.home}>{isJa ? '町ホームページ' : 'Town homepage'}</a>
        ·
        <a href={JINSEIKOGEN.sources.kanko}>{isJa ? '観光ナビ' : 'Tourism nav'}</a>
        ·
        <a href={JINSEIKOGEN.sources.tabelogCity}>{isJa ? '食べログ神石高原町' : 'Tabelog Jinseikogen'}</a>
          </p>
          <p className="facts-note">
          {isJa
          ? `数字のアクセス日は ${JINSEIKOGEN.sources.accessed}。人口は未掲載（出典ページを混ぜません）。広島県23つ目のLIVEハブ。神石郡神石高原町。`
          : `Figures accessed ${JINSEIKOGEN.sources.accessed}. Population is unpublished (universes are not mixed). Twenty-third LIVE Hiroshima hub. Jinseki District Jinseikogen.`}
          </p>
        </details>
        ...
        <details className="facts">
          <summary>{isJa ? '世羅町の基礎情報' : 'Sera facts'}</summary>
          <table>
            <tbody>
              <tr>
                <th>{isJa ? '町名' : 'Name'}</th>
                <td>
              {SERA.nameJa} / {SERA.nameEn}（{SERA.reading}）
                </td>
              </tr>
              <tr>
                <th>{isJa ? '都道府県' : 'Prefecture'}</th>
                <td>
              <Link href="/hiroshima">{isJa ? SERA.prefectureJa : SERA.prefectureEn}</Link>
                </td>
              </tr>
              <tr>
                <th>JIS</th>
                <td>
              <strong>{SERA.jis}</strong>
                </td>
              </tr>
              <tr>
                <th>JLIS</th>
              ...
              <tr>
                <th>{isJa ? '役場' : 'Town hall'}</th>
                <td>
              〒{SERA.hall.postalCode} {isJa ? SERA.hall.addressJa : SERA.hall.addressEn}
              ·
              {SERA.hall.phone} · <a href={SERA.sameAs}>sameAs {SERA.sameAs}</a>
                </td>
              </tr>
            </tbody>
          </table>
          <p>
        <a href={SERA.sources.hall}>{isJa ? '役場案内' : 'Hall guide'}</a>
        ·
        <a href={SERA.sources.home}>{isJa ? '町ホームページ' : 'Town homepage'}</a>
        ·
        <a href={SERA.sources.kanko}>{isJa ? '観光ナビ' : 'Tourism nav'}</a>
        ·
        <a href={SERA.sources.tabelogCity}>{isJa ? '食べログ世羅町' : 'Tabelog Sera'}</a>
          </p>
          <p className="facts-note">
          {isJa
          ? `数字のアクセス日は ${SERA.sources.accessed}。人口は未掲載（出典ページを混ぜません）。広島県22つ目のLIVEハブ。世羅郡世羅町。`
          : `Figures accessed ${SERA.sources.accessed}. Population is unpublished (universes are not mixed). Twenty-second LIVE Hiroshima hub. Sera District Sera.`}
          </p>
        </details>



) : town.slug === 'osakikamijima' ? (
        <details className="facts">
          <summary>{isJa ? '大崎上島町の基礎情報' : 'Osakikamijima facts'}</summary>
          <table>
            <tbody>
              <tr>
                <th>{isJa ? '町名' : 'Name'}</th>
                <td>
              {OSAKIKAMIJIMA.nameJa} / {OSAKIKAMIJIMA.nameEn}（{OSAKIKAMIJIMA.reading}）
                </td>
              </tr>
              <tr>
                <th>{isJa ? '都道府県' : 'Prefecture'}</th>
                <td>
              <Link href="/hiroshima">{isJa ? OSAKIKAMIJIMA.prefectureJa : OSAKIKAMIJIMA.prefectureEn}</Link>
                </td>
              </tr>
              <tr>
                <th>JIS</th>
                <td>
              <strong>{OSAKIKAMIJIMA.jis}</strong>
                </td>
              </tr>
              <tr>
                <th>JLIS</th>
                <td>{OSAKIKAMIJIMA.jlis}</td>
              </tr>
              <tr>
                <th>{isJa ? '役場' : 'Town hall'}</th>
                <td>
              〒{OSAKIKAMIJIMA.hall.postalCode} {isJa ? OSAKIKAMIJIMA.hall.addressJa : OSAKIKAMIJIMA.hall.addressEn}
              ·
              {OSAKIKAMIJIMA.hall.phone} · <a href={OSAKIKAMIJIMA.sameAs}>sameAs {OSAKIKAMIJIMA.sameAs}</a>
                </td>
              </tr>
            </tbody>
          </table>
          <p>
        <a href={OSAKIKAMIJIMA.sources.hall}>{isJa ? '役場案内' : 'Hall guide'}</a>
        ·
        <a href={OSAKIKAMIJIMA.sources.home}>{isJa ? '町ホームページ' : 'Town homepage'}</a>
        ·
        <a href={OSAKIKAMIJIMA.sources.kanko}>{isJa ? '観光ナビ' : 'Tourism nav'}</a>
        ·
        <a href={OSAKIKAMIJIMA.sources.tabelogCity}>{isJa ? '食べログ大崎上島町' : 'Tabelog Osakikamijima'}</a>
          </p>
          <p className="facts-note">
          {isJa
          ? `数字のアクセス日は ${OSAKIKAMIJIMA.sources.accessed}。人口は未掲載（出典ページを混ぜません）。広島県21つ目のLIVEハブ。豊田郡大崎上島町。`
          : `Figures accessed ${OSAKIKAMIJIMA.sources.accessed}. Population is unpublished (universes are not mixed). Twenty-first LIVE Hiroshima hub. Toyota District Osakikamijima.`}
          </p>
        </details>
        ...
        <details className="facts">
          <summary>{isJa ? '江田島市の基礎情報' : 'Etajima City facts'}</summary>
          <table>
            <tbody>
              <tr>
                <th>{isJa ? '名称' : 'Name'}</th>
                <td>
              {ETAJIMA.nameJa} / {ETAJIMA.nameEn}（{ETAJIMA.reading}）
                </td>
              </tr>
              <tr>
                <th>{isJa ? '都道府県' : 'Prefecture'}</th>
                <td>
              <Link href="/hiroshima">{isJa ? ETAJIMA.prefectureJa : ETAJIMA.prefectureEn}</Link>
                </td>
              </tr>
              <tr>
                <th>JIS</th>
                <td>
              <strong>{ETAJIMA.jis}</strong>
                </td>
              </tr>
              <tr>
                <th>JLIS</th>
              ...
              <tr>
                <th>{isJa ? '市役所' : 'City hall'}</th>
                <td>
              〒{ETAJIMA.hall.postalCode} {isJa ? ETAJIMA.hall.addressJa : ETAJIMA.hall.addressEn}
                  <br />
              {ETAJIMA.hall.phone} · <a href={ETAJIMA.sameAs}>sameAs {ETAJIMA.sameAs}</a>
                </td>
              </tr>
            </tbody>
          </table>
          <p className="facts-links">
        <a href={ETAJIMA.sources.hall}>{isJa ? '市役所案内' : 'Hall guide'}</a>
            {' · '}
        <a href={ETAJIMA.sources.home}>{isJa ? '市ホームページ' : 'City homepage'}</a>
            {' · '}
        <a href={ETAJIMA.sources.kanko}>{isJa ? '観光ナビ' : 'Tourism nav'}</a>
            {' · '}
        <a href={ETAJIMA.sources.tabelogCity}>{isJa ? '食べログ江田島市' : 'Tabelog Etajima'}</a>
          </p>
          <p className="facts-note">
            {isJa
          ? `数字のアクセス日は ${ETAJIMA.sources.accessed}。人口は未掲載（出典ページを混ぜません）。広島県14つ目のLIVEハブ。`
          : `Figures accessed ${ETAJIMA.sources.accessed}. Population is unpublished (universes are not mixed). Fourteenth LIVE Hiroshima hub.`}
          </p>
        </details>
        ...
        <details className="facts">
          <summary>{isJa ? '安芸高田市の基礎情報' : 'Akitakata City facts'}</summary>
          <table>
            <tbody>
              <tr>
                <th>{isJa ? '名称' : 'Name'}</th>
                <td>
              {AKITAKATA.nameJa} / {AKITAKATA.nameEn}（{AKITAKATA.reading}）
                </td>
              </tr>
              <tr>
                <th>{isJa ? '都道府県' : 'Prefecture'}</th>
                <td>
              <Link href="/hiroshima">{isJa ? AKITAKATA.prefectureJa : AKITAKATA.prefectureEn}</Link>
                </td>
              </tr>
              <tr>
                <th>JIS</th>
                <td>
              <strong>{AKITAKATA.jis}</strong>
                </td>
              </tr>
              <tr>
                <th>JLIS</th>
                <td>{AKITAKATA.jlis}</td>
              </tr>
              <tr>
                <th>{isJa ? '市役所' : 'City hall'}</th>
                <td>
              〒{AKITAKATA.hall.postalCode} {isJa ? AKITAKATA.hall.addressJa : AKITAKATA.hall.addressEn}
                  <br />
              {AKITAKATA.hall.phone} · <a href={AKITAKATA.sameAs}>sameAs {AKITAKATA.sameAs}</a>
                </td>
              </tr>
            </tbody>
          </table>
          <p className="facts-links">
        <a href={AKITAKATA.sources.hall}>{isJa ? '市役所案内' : 'Hall guide'}</a>
            {' · '}
        <a href={AKITAKATA.sources.home}>{isJa ? '市ホームページ' : 'City homepage'}</a>
            {' · '}
        <a href={AKITAKATA.sources.kanko}>{isJa ? '観光ナビ' : 'Tourism nav'}</a>
            {' · '}
        <a href={AKITAKATA.sources.tabelogCity}>{isJa ? '食べログ安芸高田市' : 'Tabelog Akitakata'}</a>
          </p>
          <p className="facts-note">
            {isJa
          ? `数字のアクセス日は ${AKITAKATA.sources.accessed}。人口は未掲載（出典ページを混ぜません）。広島県13つ目のLIVEハブ。`
          : `Figures accessed ${AKITAKATA.sources.accessed}. Population is unpublished (universes are not mixed). Thirteenth LIVE Hiroshima hub.`}
          </p>
        </details>



) : town.slug === 'hatsukaichi' ? (
        <details className="facts">
          <summary>{isJa ? '廿日市の基礎情報' : 'Hatsukaichi City facts'}</summary>
          <table>
            <tbody>
              <tr>
                <th>{isJa ? '名称' : 'Name'}</th>
                <td>
              {HATSUKAICHI.nameJa} / {HATSUKAICHI.nameEn}（{HATSUKAICHI.reading}）
                </td>
              </tr>
              <tr>
                <th>{isJa ? '都道府県' : 'Prefecture'}</th>
                <td>
              <Link href="/hiroshima">{isJa ? HATSUKAICHI.prefectureJa : HATSUKAICHI.prefectureEn}</Link>
                </td>
              </tr>
              <tr>
                <th>JIS</th>
                <td>
              <strong>{HATSUKAICHI.jis}</strong>
                </td>
              </tr>
              <tr>
                <th>JLIS</th>
                <td>{HATSUKAICHI.jlis}</td>
              </tr>
              <tr>
                <th>{isJa ? '市役所' : 'City hall'}</th>
                <td>
              〒{HATSUKAICHI.hall.postalCode} {isJa ? HATSUKAICHI.hall.addressJa : HATSUKAICHI.hall.addressEn}
                  <br />
              {HATSUKAICHI.hall.phone} · <a href={HATSUKAICHI.sameAs}>sameAs {HATSUKAICHI.sameAs}</a>
                </td>
              </tr>
            </tbody>
          </table>
          <p className="facts-links">
        <a href={HATSUKAICHI.sources.hall}>{isJa ? '市役所案内' : 'Hall guide'}</a>
            {' · '}
        <a href={HATSUKAICHI.sources.home}>{isJa ? '市ホームページ' : 'City homepage'}</a>
            {' · '}
        <a href={HATSUKAICHI.sources.kanko}>{isJa ? '観光ナビ' : 'Tourism nav'}</a>
            {' · '}
        <a href={HATSUKAICHI.sources.tabelogCity}>{isJa ? '食べログ廿日市' : 'Tabelog Hatsukaichi'}</a>
          </p>
          <p className="facts-note">
            {isJa
          ? `数字のアクセス日は ${HATSUKAICHI.sources.accessed}。人口は未掲載（出典ページを混ぜません）。広島県12つ目のLIVEハブ。`
          : `Figures accessed ${HATSUKAICHI.sources.accessed}. Population is unpublished (universes are not mixed). Twelfth LIVE Hiroshima hub.`}
          </p>
        </details>
