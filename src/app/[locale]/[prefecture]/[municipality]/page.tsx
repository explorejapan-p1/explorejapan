                                  ...
                                  : muni.slug === 'naka'
                                    ...
                                    : muni.slug === 'ayagawa'
                                      ...
                                      : muni.slug === 'okawa'
                                        ? loc === 'ja'
                                          ? '大川村。小金滝、白滝の里、吉野川、食。'
                                          : 'Okawa Village — Kogane Falls, Shirataki-no-Sato, Yoshino River, food.'
                                      : muni.slug === 'niyodogawa'
                                        ? loc === 'ja'
