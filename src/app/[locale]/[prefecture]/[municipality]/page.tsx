    ...
    <>
      ...
      <p className="note">
        ...
        <a href={SERA.sources.tabelogCity}>{isJa ? '食べログ世羅町' : 'Tabelog Sera'}</a>
          ...
          <p className="facts-note">
          {isJa
          ? `数字のアクセス日は ${SERA.sources.accessed}。人口は未掲載（出典ページを混ぜません）。広島県21つ目のLIVEハブ。豊田郡世羅町。`
          : `Figures accessed ${SERA.sources.accessed}. Population is unpublished (universes are not mixed). Twenty-first LIVE Hiroshima hub. Toyota District Sera.`}
          </p>
        </details>
