...
export async function generateMetadata({params}: Props) {
  ...
  return shareMetadata({
    ...
    description: live
      ? loc === 'ja'
        ? '徳島県の市町村。徳島市・鳴門市・美馬市・つるぎ町・吉野川市・三好市・阿波市・東みよし町・北島町・松茂町。'
        : 'Municipalities in Tokushima. Listings: Tokushima City, Naruto City, Mima City, Tsurugi Town, Yoshinogawa City, Miyoshi City, Awa City, Higashimiyoshi Town, Kitajima Town, and Matsushige Town.'
      : loc === 'ja'
        ? 'この県の市町村ページは準備中です。'
