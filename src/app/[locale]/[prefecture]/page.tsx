...
import {ONOMICHI_PLACE_PHOTO} from '@/data/onomichi';
import {FUKUYAMA_PLACE_PHOTO} from '@/data/fukuyama';
import {FUCHU_PLACE_PHOTO} from '@/data/fuchu';
import {MIYOSHISHI_PLACE_PHOTO} from '@/data/miyoshishi';
import {SHOBARA_PLACE_PHOTO} from '@/data/shobara';
import {OTAKE_PLACE_PHOTO} from '@/data/otake';
import {HIGASHIHIROSHIMA_PLACE_PHOTO} from '@/data/higashihiroshima';
import {HATSUKAICHI_PLACE_PHOTO} from '@/data/hatsukaichi';
import {AKITAKATA_PLACE_PHOTO} from '@/data/akitakata';
import {ETAJIMA_PLACE_PHOTO} from '@/data/etajima';
import {FUCHUCHO_PLACE_PHOTO} from '@/data/fuchucho';
import {KAITA_PLACE_PHOTO} from '@/data/kaita';
import {KUMANO_PLACE_PHOTO} from '@/data/kumano';
import {SAKA_PLACE_PHOTO} from '@/data/saka';
import {AKIOTA_PLACE_PHOTO} from '@/data/akiota';
import {KITAHIROSHIMA_PLACE_PHOTO} from '@/data/kitahiroshima';
import {OSAKIKAMIJIMA_PLACE_PHOTO} from '@/data/osakikamijima';
import {SERA_PLACE_PHOTO} from '@/data/sera';
import {JINSEIKOGEN_PLACE_PHOTO} from '@/data/jinseikogen';
...
const MUNI_CARD_PHOTO: Record<string, MimaPlacePhoto> = {
  ...
  miharashi: MIHARASHI_PLACE_PHOTO,
  onomichi: ONOMICHI_PLACE_PHOTO,
  fukuyama: FUKUYAMA_PLACE_PHOTO,
  fuchu: FUCHU_PLACE_PHOTO,
  miyoshishi: MIYOSHISHI_PLACE_PHOTO,
  shobara: SHOBARA_PLACE_PHOTO,
  otake: OTAKE_PLACE_PHOTO,
  higashihiroshima: HIGASHIHIROSHIMA_PLACE_PHOTO,
  hatsukaichi: HATSUKAICHI_PLACE_PHOTO,
  akitakata: AKITAKATA_PLACE_PHOTO,
  etajima: ETAJIMA_PLACE_PHOTO,
  fuchucho: FUCHUCHO_PLACE_PHOTO,
  kaita: KAITA_PLACE_PHOTO,
  kumano: KUMANO_PLACE_PHOTO,
  saka: SAKA_PLACE_PHOTO,
  akiota: AKIOTA_PLACE_PHOTO,
  kitahiroshima: KITAHIROSHIMA_PLACE_PHOTO,
