 ...
 * Hiroshima City + Kure + Takehara + Mihara + Onomichi + Fukuyama + Fuchu + Miyoshishi + Shobara + Otake + Higashihiroshima + Hatsukaichi LIVE hubs.
...
export const HIROSHIMA_MUNICIPALITIES: Municipality[] = [
  ...
  {jis: '34213', slug: 'hatsukaichi', nameJa: '廿日市市', nameEn: 'Hatsukaichi', status: 'ready'},
