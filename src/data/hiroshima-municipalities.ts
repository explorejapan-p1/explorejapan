 ...
 * Hiroshima City + Kure + Takehara + Mihara + Onomichi + Fukuyama + Fuchu + Miyoshishi + Shobara + Otake + Higashihiroshima + Hatsukaichi + Akitakata + Etajima + Fuchucho + Kaita + Kumano + Saka + Akiota + Kitahiroshima + Osakikamijima LIVE hubs.
...
export const HIROSHIMA_MUNICIPALITIES: Municipality[] = [
  ...
  {jis: '34203', slug: 'takehara', nameJa: '竹原市', nameEn: 'Takehara', status: 'ready'},
  {jis: '34204', slug: 'miharashi', nameJa: '三原市', nameEn: 'Mihara', status: 'ready'},
  {jis: '34205', slug: 'onomichi', nameJa: '尾道市', nameEn: 'Onomichi', status: 'ready'},
  {jis: '34207', slug: 'fukuyama', nameJa: '福山市', nameEn: 'Fukuyama', status: 'ready'},
  {jis: '34208', slug: 'fuchu', nameJa: '府中市', nameEn: 'Fuchu', status: 'ready'},
  {jis: '34209', slug: 'miyoshishi', nameJa: '三次市', nameEn: 'Miyoshi', status: 'ready'},
  {jis: '34210', slug: 'shobara', nameJa: '庄原市', nameEn: 'Shobara', status: 'ready'},
  {jis: '34211', slug: 'otake', nameJa: '大竹市', nameEn: 'Otake', status: 'ready'},
  ...
  {jis: '34368', slug: 'akiota', nameJa: '安芸太田町', nameEn: 'Akiota', status: 'ready'},
  {jis: '34369', slug: 'kitahiroshima', nameJa: '北広島町', nameEn: 'Kitahiroshima', status: 'ready'},
  {jis: '34431', slug: 'osakikamijima', nameJa: '大崎上島町', nameEn: 'Osakikamijima', status: 'ready'},
  {jis: '34462', slug: 'sera', nameJa: '世羅町', nameEn: 'Sera', status: 'ready'},
  {jis: '34545', slug: 'jinseikogen', nameJa: '神石高原町', nameEn: 'Jinseikogen', status: 'ready'}
];
