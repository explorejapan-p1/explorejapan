 ...
 * No frozen pack — photo-only tourism + Tabelog dining + Rakuten stay/onsen. Stay: 北川村温泉 ゆずの宿 客室和洋. Onsen: 同施設 温泉大浴場 still (stay≠onsen). Shop/commerce honest 0.
 */
...
export const KITAGAWA_EXPECTED_ROW_COUNT = 6;
export const KITAGAWA_EXPECTED_GEO_COUNT = 6;
