...
import {
  kitahiroshimaPackRowMatchesFilter,
  rankKitahiroshimaSeeRows,
  kitahiroshimaSightPhoto,
  kitahiroshimaSourcedHook,
  kitahiroshimaTopChipForRow,
  resolveKitahiroshimaFilter,
...
import {
  ...
  jinseikogenPackRowMatchesFilter,
  rankJinseikogenSeeRows,
  jinseikogenSightPhoto,
  jinseikogenSourcedHook,
...
import {
  ...
  kurashikiPackRowMatchesFilter,
  rankKurashikiSeeRows,
  kurashikiSightPhoto,
  kurashikiSourcedHook,
  kurashikiTopChipForRow,
  resolveKurashikiFilter
} from './kurashiki-travel';
import {
  isTsuyamaOnsenPackRow,
  isTsuyamaExperiencePackRow,
  isTsuyamaStayPackRow,
  tsuyamaPackRowMatchesFilter,
  rankTsuyamaSeeRows,
  tsuyamaSightPhoto,
  tsuyamaSourcedHook,
...
const KURASHIKI_HELPERS: LookupHelpers = {
  isOnsenPackRow: isKurashikiOnsenPackRow,
  isExperiencePackRow: isKurashikiExperiencePackRow,
  isStayPackRow: isKurashikiStayPackRow,
  packRowMatchesFilter: kurashikiPackRowMatchesFilter,
  rankSeeRows: rankKurashikiSeeRows,
  sightPhoto: kurashikiSightPhoto,
  sourcedHook: kurashikiSourcedHook,
  topChipForRow: kurashikiTopChipForRow,
  resolveFilter: resolveKurashikiFilter
};

const TSUYAMA_HELPERS: LookupHelpers = {
  isOnsenPackRow: isTsuyamaOnsenPackRow,
  isExperiencePackRow: isTsuyamaExperiencePackRow,
  isStayPackRow: isTsuyamaStayPackRow,
  packRowMatchesFilter: tsuyamaPackRowMatchesFilter,
  rankSeeRows: rankTsuyamaSeeRows,
  sightPhoto: tsuyamaSightPhoto,
  sourcedHook: tsuyamaSourcedHook,
  topChipForRow: tsuyamaTopChipForRow,
...
const JINSEIKOGEN_HELPERS: LookupHelpers = {
  ...
  isStayPackRow: isJinseikogenStayPackRow,
  packRowMatchesFilter: jinseikogenPackRowMatchesFilter,
  rankSeeRows: rankJinseikogenSeeRows,
  sightPhoto: jinseikogenSightPhoto,
  sourcedHook: jinseikogenSourcedHook,
  topChipForRow: jinseikogenTopChipForRow,
  resolveFilter: resolveJinseikogenFilter
};
...
const KITAHIROSHIMA_HELPERS: LookupHelpers = {
  ...
  isStayPackRow: isKitahiroshimaStayPackRow,
  packRowMatchesFilter: kitahiroshimaPackRowMatchesFilter,
  rankSeeRows: rankKitahiroshimaSeeRows,
  sightPhoto: kitahiroshimaSightPhoto,
  sourcedHook: kitahiroshimaSourcedHook,
  topChipForRow: kitahiroshimaTopChipForRow,
  resolveFilter: resolveKitahiroshimaFilter
};
