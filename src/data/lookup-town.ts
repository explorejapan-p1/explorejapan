...
export type LookupTown = {
  slug: ReadySlug;
  prefectureSlug: 'tokushima' | 'kagawa' | 'kochi' | 'ehime';
  jis: string;
  nameJa: string;
  nameEn: string;
