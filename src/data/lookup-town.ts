...
export function prefSlugForReady(slug: ReadySlug): PrefSlug {
  if (slug === 'hiroshima' || slug === 'kure' || slug === 'takehara' || slug === 'miharashi' || slug === 'onomichi' || slug === 'fukuyama' || slug === 'fuchu' || slug === 'miyoshishi' || slug === 'shobara' || slug === 'otake' || slug === 'higashihiroshima' || slug === 'hatsukaichi' || slug === 'akitakata') return 'hiroshima';
