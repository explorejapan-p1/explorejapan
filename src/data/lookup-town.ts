...
export function prefSlugForReady(slug: ReadySlug): PrefSlug {
  if (slug === 'takamatsu' || slug === 'kotohira' || slug === 'marugame' || slug === 'kanonji' || slug === 'sakaide' || slug === 'naoshima' || slug === 'shodoshima' || slug === 'zentsuji' || slug === 'mitoyo' || slug === 'utazu') return 'kagawa';
  return 'tokushima';
}
