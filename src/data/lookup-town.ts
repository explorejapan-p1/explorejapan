...
export function prefSlugForReady(slug: ReadySlug): PrefSlug {
  if (slug === 'matsuyama' || slug === 'imabari' || slug === 'uwajima' || slug === 'yawatahama' || slug === 'niihama' || slug === 'saijo' || slug === 'ozu' || slug === 'iyo' || slug === 'shikokuchuo' || slug === 'seiyo' || slug === 'toon' || slug === 'kamijima') return 'ehime';
