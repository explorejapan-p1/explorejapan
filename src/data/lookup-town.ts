...
export function prefSlugForReady(slug: ReadySlug): PrefSlug {
  if (slug === 'hiroshima' || slug === 'kure' || slug === 'takehara' || slug === 'miharashi' || slug === 'onomichi' || slug === 'fukuyama') return 'hiroshima';
