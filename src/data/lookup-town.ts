...
export function prefSlugForReady(slug: ReadySlug): PrefSlug {
  if (slug === 'kochi' || slug === 'nankoku' || slug === 'konan' || slug === 'kami' || slug === 'ino' || slug === 'aki' || slug === 'muroto' || slug === 'tosa' || slug === 'susaki' || slug === 'shimanto' || slug === 'tosashimizu') return 'kochi';
