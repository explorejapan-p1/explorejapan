...
export function prefSlugForReady(slug: ReadySlug): PrefSlug {
  if (slug === 'kochi' || slug === 'nankoku' || slug === 'konan' || slug === 'kami') return 'kochi';
