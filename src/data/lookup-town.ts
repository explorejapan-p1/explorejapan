...
export function prefSlugForReady(slug: ReadySlug): PrefSlug {
  if (slug === 'matsuyama' || slug === 'imabari' || slug === 'uwajima' || slug === 'yawatahama' || slug === 'niihama') return 'ehime';
