...
export function isReadySlug(slug: string): slug is ReadySlug {
  return slug === 'mima' || slug === 'tsurugi' || slug === 'yoshinogawa' || slug === 'miyoshi' || slug === 'tokushima' || slug === 'awa' || slug === 'higashimiyoshi' || slug === 'kitajima' || slug === 'naruto' || slug === 'matsushige' || slug === 'ishii' || slug === 'itano' || slug === 'kamiita' || slug === 'kamiyama' || slug === 'katsuura' || slug === 'kamikatsu' || slug === 'sanagochi' || slug === 'naka' || slug === 'mugi' || slug === 'minami' || slug === 'kaiyo' || slug === 'aizumi' || slug === 'komatsushima' || slug === 'anan' || slug === 'takamatsu' || slug === 'kotohira' || slug === 'marugame' || slug === 'kanonji' || slug === 'sakaide' || slug === 'naoshima' || slug === 'shodoshima' || slug === 'zentsuji' || slug === 'mitoyo' || slug === 'utazu' || slug === 'tonosho' || slug === 'sanuki' || slug === 'higashikagawa' || slug === 'miki' || slug === 'ayagawa' || slug === 'tadotsu' || slug === 'manno' || slug === 'kochi' || slug === 'nankoku' || slug === 'konan' || slug === 'kami' || slug === 'ino' || slug === 'aki' || slug === 'muroto' || slug === 'tosa' || slug === 'susaki'
}
...
export function prefSlugForReady(slug: ReadySlug): PrefSlug {
  if (slug === 'kochi' || slug === 'nankoku' || slug === 'konan' || slug === 'kami' || slug === 'ino' || slug === 'aki' || slug === 'muroto' || slug === 'tosa' || slug === 'susaki') return 'kochi';
