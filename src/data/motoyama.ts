 ...
 * No frozen pack — photo-only tourism + Tabelog dining + Rakuten stay. Stay: 一軒宿あせみ 和洋室 LARGE (share/plan noplan-asemi). Onsen: 0 (private shower only; stay≠onsen). Shop/commerce honest 0.
 */
...
export const MOTOYAMA_EXPECTED_ROW_COUNT = 5;
export const MOTOYAMA_EXPECTED_GEO_COUNT = 5;
