...
export const KUROSHIO_LOOKUP: LookupTown = {
  ...
  mapCitePackJa: '点は町・公式ページ掲載施設のWikipedia/Commons等出典座標9件（accessed 2026-09-09）。',
  mapCitePackEn: 'Points: 9 sourced coordinates for town/official facilities (accessed 2026-09-09).',
  licenseNoteJa: '行のライセンスは町公式・公式観光サイト掲載情報。町ページの事実の転記で、オープンデータ許諾ではありません。',
...
export const TOYO_LOOKUP: LookupTown = {
  ...
  coverageJa:
    '東洋町（JIS 39301）観光8・宿泊1・飲食8・温泉0・体験1（出典写真がある施設のみ）。買物・商業・AED・医療機関・介護・避難所・文化財・GTFSは0件（未掲載）。オープンデータ凍結パックは未掲載。高知県14つ目のLIVEハブ。',
  coverageEn:
    'Toyo Town (JIS 39301), 8 tourism + 1 stay + 8 dining + 0 onsen + 1 experience with sourced photos. Shopping, commerce, AED, hospitals, care, shelters, cultural property, GTFS: 0, unpublished. No frozen open-data pack. Fourteenth LIVE Kochi hub.',
  mapLabelJa: '東洋町の出典座標9件',
  mapLabelEn: '9 sourced coordinates in Toyo Town',
  mapCitePackJa: '点は町・公式ページ掲載施設のWikipedia/Commons等出典座標9件（accessed 2026-09-09）。',
  mapCitePackEn: 'Points: 9 sourced coordinates for town/official facilities (accessed 2026-09-09).',
  licenseNoteJa: '行のライセンスは町公式・公式観光サイト掲載情報。町ページの事実の転記で、オープンデータ許諾ではありません。',
...
export const KITAGAWA_LOOKUP: LookupTown = {
  ...
  mapCitePackJa: '点は村・公式ページ掲載施設のWikipedia/Commons/楽天等出典座標9件（accessed 2026-09-09）。',
...
export const MOTOYAMA_LOOKUP: LookupTown = {
  ...
  coverageJa:
    '本山町（JIS 39341）観光7・宿泊1・飲食7・温泉0・体験0（出典写真がある施設のみ）。買物・商業・AED・医療機関・介護・避難所・文化財・GTFSは0件（未掲載）。オープンデータ凍結パックは未掲載。高知県20つ目のLIVEハブ。',
  coverageEn:
    'Motoyama Town (JIS 39341), 7 tourism + 1 stay + 7 dining + 0 onsen + 0 experience with sourced photos. Shopping, commerce, AED, hospitals, care, shelters, cultural property, GTFS: 0, unpublished. No frozen open-data pack. Twentieth LIVE Kochi hub.',
  mapLabelJa: '本山町の出典座標7件',
  mapLabelEn: '7 sourced coordinates in Motoyama Town',
  mapCitePackJa: '点は町・公式ページ掲載施設のWikipedia/Commons/楽天等出典座標7件（accessed 2026-09-09）。',
  mapCitePackEn: 'Points: 7 sourced coordinates for town/official facilities (accessed 2026-09-09).',
  licenseNoteJa: '行のライセンスは町公式・公式観光サイト掲載情報。町ページの事実の転記で、オープンデータ許諾ではありません。',
...
export const OTOYO_LOOKUP: LookupTown = {
  ...
  coverageJa:
    '大豊町（JIS 39344）観光7・宿泊1・飲食7・温泉0・体験1（出典写真がある施設のみ）。買物・商業・AED・医療機関・介護・避難所・文化財・GTFSは0件（未掲載）。オープンデータ凍結パックは未掲載。高知県21つ目のLIVEハブ。',
  coverageEn:
    'Otoyo Town (JIS 39344), 7 tourism + 1 stay + 7 dining + 0 onsen + 1 experience with sourced photos. Shopping, commerce, AED, hospitals, care, shelters, cultural property, GTFS: 0, unpublished. No frozen open-data pack. Twenty-first LIVE Kochi hub.',
  mapLabelJa: '大豊町の出典座標8件',
  mapLabelEn: '8 sourced coordinates in Otoyo Town',
...
export const NAHARI_LOOKUP: LookupTown = {
  ...
  coverageJa:
    '奈半利町（JIS 39302）観光7・宿泊1・飲食10・温泉0・体験0（出典写真がある施設のみ）。買物・商業・AED・医療機関・介護・避難所・文化財・GTFSは0件（未掲載）。オープンデータ凍結パックは未掲載。高知県15つ目のLIVEハブ。',
  coverageEn:
    'Nahari Town (JIS 39302), 7 tourism + 1 stay + 10 dining + 0 onsen + 0 experience with sourced photos. Shopping, commerce, AED, hospitals, care, shelters, cultural property, GTFS: 0, unpublished. No frozen open-data pack. Fifteenth LIVE Kochi hub.',
  mapLabelJa: '奈半利町の出典座標7件',
  mapLabelEn: '7 sourced coordinates in Nahari Town',
  mapCitePackJa: '点は町・公式ページ掲載施設のWikipedia/Commons等出典座標5件（accessed 2026-09-09）。',
  mapCitePackEn: 'Points: 7 sourced coordinates for town/official facilities (accessed 2026-09-09).',
  licenseNoteJa: '行のライセンスは町公式・公式観光サイト掲載情報。町ページの事実の転記で、オープンデータ許諾ではありません。',
...
export const OKAWA_LOOKUP: LookupTown = {
  ...
  coverageJa:
    '大川村（JIS 39364）観光6・宿泊1・飲食2・温泉0・体験1（出典写真がある施設のみ）。買物・商業・AED・医療機関・介護・避難所・文化財・GTFSは0件（未掲載）。オープンデータ凍結パックは未掲載。高知県23つ目のLIVEハブ。TG610 densify。',
  coverageEn:
    'Okawa Village (JIS 39364), 6 tourism + 1 stay + 2 dining + 0 onsen + 1 experience with sourced photos. Shopping, commerce, AED, hospitals, care, shelters, cultural property, GTFS: 0, unpublished. No frozen open-data pack. Twenty-third LIVE Kochi hub. TG610 densify.',
  mapLabelJa: '大川村の出典座標7件',
  mapLabelEn: '7 sourced coordinates in Okawa Village',
  mapCitePackJa: '点は村・公式ページ掲載施設のWikipedia/Commons/楽天等出典座標7件（accessed 2026-09-09）。',
  mapCitePackEn: 'Points: 7 sourced coordinates for village/official facilities (accessed 2026-09-09).',
  licenseNoteJa: '行のライセンスは村公式・公式観光サイト掲載情報。村ページの事実の転記で、オープンデータ許諾ではありません。',
...
export const OCHI_LOOKUP: LookupTown = {
  ...
  coverageJa:
    '越知町（JIS 39403）観光7・宿泊1・飲食9・温泉0・体験0（出典写真がある施設のみ）。買物・商業・AED・医療機関・介護・避難所・文化財・GTFSは0件（未掲載）。オープンデータ凍結パックは未掲載。高知県26つ目のLIVEハブ。',
  coverageEn:
    'Ochi Town (JIS 39403), 7 tourism + 1 stay + 9 dining + 0 onsen + 0 experience with sourced photos. Shopping, commerce, AED, hospitals, care, shelters, cultural property, GTFS: 0, unpublished. No frozen open-data pack. Twenty-sixth LIVE Kochi hub.',
  mapLabelJa: '越知町の出典座標7件',
  mapLabelEn: '7 sourced coordinates in Ochi Town',
  mapCitePackJa: '点は町・公式ページ掲載施設のWikipedia/Commons/Snow Peak等出典座標7件（accessed 2026-09-09）。',
  mapCitePackEn: 'Points: 7 sourced coordinates for town/official facilities (accessed 2026-09-09).',
  licenseNoteJa: '行のライセンスは町公式・公式観光サイト掲載情報。町ページの事実の転記で、オープンデータ許諾ではありません。',
...
export const YUSUHARA_LOOKUP: LookupTown = {
  ...
  coverageJa:
    '梼原町（JIS 39405）観光7・宿泊1・飲食7・温泉0・体験0（出典写真がある施設のみ）。買物・商業・AED・医療機関・介護・避難所・文化財・GTFSは0件（未掲載）。オープンデータ凍結パックは未掲載。高知県27つ目のLIVEハブ。',
  coverageEn:
    'Yusuhara Town (JIS 39405), 7 tourism + 1 stay + 7 dining + 0 onsen + 0 experience with sourced photos. Shopping, commerce, AED, hospitals, care, shelters, cultural property, GTFS: 0, unpublished. No frozen open-data pack. Twenty-seventh LIVE Kochi hub.',
  mapLabelJa: '梼原町の出典座標7件',
  mapLabelEn: '7 sourced coordinates in Yusuhara Town',
  mapCitePackJa: '点は町・公式ページ掲載施設のWikipedia/Commons/OSM等出典座標5件（accessed 2026-09-09）。',
  mapCitePackEn: 'Points: 7 sourced coordinates for town/official facilities (accessed 2026-09-09).',
  licenseNoteJa: '行のライセンスは町公式・公式観光サイト掲載情報。町ページの事実の転記で、オープンデータ許諾ではありません。',
...
export const HIDAKA_LOOKUP: LookupTown = {
  ...
  coverageJa:
    '日高村（JIS 39410）観光5・宿泊1・飲食8・温泉0・体験0（出典写真がある施設のみ）。買物・商業・AED・医療機関・介護・避難所・文化財・GTFSは0件（未掲載）。オープンデータ凍結パックは未掲載。高知県28つ目のLIVEハブ。',
  coverageEn:
    'Hidaka Village (JIS 39410), 5 tourism + 1 stay + 8 dining + 0 onsen + 0 experience with sourced photos. Shopping, commerce, AED, hospitals, care, shelters, cultural property, GTFS: 0, unpublished. No frozen open-data pack. Twenty-eighth LIVE Kochi hub.',
  mapLabelJa: '日高村の出典座標5件',
  mapLabelEn: '5 sourced coordinates in Hidaka Village',
  mapCitePackJa: '点は村・公式ページ掲載施設のWikipedia/Commons/OSM等出典座標5件（accessed 2026-09-09）。',
  mapCitePackEn: 'Points: 7 sourced coordinates for village/official facilities (accessed 2026-09-09).',
  licenseNoteJa: '行のライセンスは村公式・公式観光サイト掲載情報。村ページの事実の転記で、オープンデータ許諾ではありません。',
...
export const TSUNO_LOOKUP: LookupTown = {
  ...
  coverageJa:
    '津野町（JIS 39411）観光7・宿泊1・飲食8・温泉0・体験0（出典写真がある施設のみ）。買物・商業・AED・医療機関・介護・避難所・文化財・GTFSは0件（未掲載）。オープンデータ凍結パックは未掲載。高知県29つ目のLIVEハブ。',
  coverageEn:
    'Tsuno Town (JIS 39411), 7 tourism + 1 stay + 8 dining + 0 onsen + 0 experience with sourced photos. Shopping, commerce, AED, hospitals, care, shelters, cultural property, GTFS: 0, unpublished. No frozen open-data pack. Twenty-ninth LIVE Kochi hub.',
  mapLabelJa: '津野町の出典座標7件',
  mapLabelEn: '7 sourced coordinates in Tsuno Town',
  mapCitePackJa: '点は町・公式ページ掲載施設のWikipedia/Commons/OSM等出典座標5件（accessed 2026-09-09）。',
  mapCitePackEn: 'Points: 7 sourced coordinates for town/official facilities (accessed 2026-09-09).',
  licenseNoteJa: '行のライセンスは町公式・公式観光サイト掲載情報。町ページの事実の転記で、オープンデータ許諾ではありません。',
...
export const NAKATOSA_LOOKUP: LookupTown = {
  ...
  coverageJa:
    '中土佐町（JIS 39401）観光7・宿泊1・飲食12・温泉0・体験0（出典写真がある施設のみ）。買物・商業・AED・医療機関・介護・避難所・文化財・GTFSは0件（未掲載）。オープンデータ凍結パックは未掲載。高知県25つ目のLIVEハブ。',
  coverageEn:
    'Nakatosa Town (JIS 39401), 7 tourism + 1 stay + 12 dining + 0 onsen + 0 experience with sourced photos. Shopping, commerce, AED, hospitals, care, shelters, cultural property, GTFS: 0, unpublished. No frozen open-data pack. Twenty-fifth LIVE Kochi hub.',
  mapLabelJa: '中土佐町の出典座標7件',
  mapLabelEn: '7 sourced coordinates in Nakatosa Town',
  mapCitePackJa: '点は町・公式ページ掲載施設のWikipedia/Commons/楽天等出典座標7件（accessed 2026-09-09）。',
  mapCitePackEn: 'Points: 7 sourced coordinates for town/official facilities (accessed 2026-09-09).',
  licenseNoteJa: '行のライセンスは町公式・公式観光サイト掲載情報。町ページの事実の転記で、オープンデータ許諾ではありません。',
...
export const NIYODOGAWA_LOOKUP: LookupTown = {
  ...
  coverageJa:
    '仁淀川町（JIS 39387）観光7・宿泊1・飲食8・温泉0・体験0（出典写真がある施設のみ）。買物・商業・AED・医療機関・介護・避難所・文化財・GTFSは0件（未掲載）。オープンデータ凍結パックは未掲載。高知県24つ目のLIVEハブ。',
  coverageEn:
    'Niyodogawa Town (JIS 39387), 7 tourism + 1 stay + 8 dining + 0 onsen + 0 experience with sourced photos. Shopping, commerce, AED, hospitals, care, shelters, cultural property, GTFS: 0, unpublished. No frozen open-data pack. Twenty-fourth LIVE Kochi hub.',
  mapLabelJa: '仁淀川町の出典座標7件',
  mapLabelEn: '7 sourced coordinates in Niyodogawa Town',
  mapCitePackJa: '点は町・公式ページ掲載施設のWikipedia/Commons/楽天等出典座標7件（accessed 2026-09-09）。',
  mapCitePackEn: 'Points: 7 sourced coordinates for town/official facilities (accessed 2026-09-09).',
  licenseNoteJa: '行のライセンスは町公式・公式観光サイト掲載情報。町ページの事実の転記で、オープンデータ許諾ではありません。',
